...
import {
  Tn,
  ha
} from "./chunk-D5XULO4D.js";
import {
  require_client_logger
} from "./chunk-PH6BELWB.js";
import {
  require_preview_api
} from "./chunk-TN74FMVR.js";
import {
  require_react
...
// ../../node_modules/.pnpm/@storybook+addon-docs@9.0.0_@types+react@18.3.23_storybook@9.0.0_@testing-library+dom@9.3.4_prettier@2.8.8_/node_modules/@storybook/addon-docs/dist/blocks.mjs
...
var StorySkeleton = () => import_react.default.createElement(ew, null);
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-LYDWBPGX.js");
...
var ColorPalette = ({ children, ...props }) => import_react.default.createElement(Vl, null, import_react.default.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, import_react.default.createElement(ListHeading, null, import_react.default.createElement(ListName, null, "Name"), import_react.default.createElement(ListSwatches, null, "Swatches")), children));
...
var IconGallery = ({ children, ...props }) => import_react.default.createElement(Vl, null, import_react.default.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
...
function init(customOptions) {
  ...
  if (tocElement === null || (_headingsArray = _parseContent.selectHeadings(contentElement, _options.headingSelector), _headingsArray === null))
    return;
...
`, { inline: t2 }));
    ...
    if (n3.length > 1 || i2.forceWrapper)
      ...
      if (n3.length === 1)
        return l2 = n3[0], typeof l2 == "string" ? u2("span", { key: "outer" }, l2) : l2;
      l2 = null;
    }
        ...
        let d2 = t3[s2] = function(e3, t4, n5, r3) {
          return t4 === "style" ? function(e4) {
            ...
            for (let o4 = 0; o4 < e4.length; o4++) {
              let a3 = e4[o4];
              if (a3 !== '"' && a3 !== "'" || r4 || (i3 ? a3 === l2 && (i3 = false, l2 = "") : (i3 = true, l2 = a3)), a3 === "(" && n6.endsWith("url") ? r4 = true : a3 === ")" && r4 && (r4 = false), a3 !== ";" || i3 || r4)
                n6 += a3;
              else {
                let e5 = n6.trim();
                if (e5) {
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Ir2, { variant: "outline", size: "medium", id: getControlSetterButtonId(name), onClick: onSetFalse, disabled: readonly }, "Set boolean");
...
var ObjectControl = ({ name, value: value2, onChange, argType }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement(Ir2, { disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Ir2, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-J6RQGNXB.js"));
...
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  ...
  if (!control || control.disable) {
    ...
    return isHovered && canBeSetup ? import_react.default.createElement(Ri, { href: "https://storybook.js.org/docs/essentials/controls", target: "_blank", withArrow: true }, "Setup controls") : import_react.default.createElement(NoControl, null);
  }
...
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  ...
  return import_react.default.createElement(D3, { closeOnOutsideClick: true, placement: "bottom", visible: isOpen, onVisibleChange: (isVisible) => {
    setIsOpen(isVisible);
...
var Empty = ({ inAddonPanel }) => {
  ...
  }, []), isLoading ? null : import_react.default.createElement(Wrapper9, { inAddonPanel }, import_react.default.createElement(Fo, { title: inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated", description: import_react.default.createElement(import_react.default.Fragment, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically."), footer: import_react.default.createElement(Links, null, inAddonPanel && import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(Ri, { href: "https://storybook.js.org/docs/essentials/controls", target: "_blank", withArrow: true }, import_react.default.createElement(DocumentIcon, null), " Read docs")), !inAddonPanel && import_react.default.createElement(Ri, { href: "https://storybook.js.org/docs/essentials/controls", target: "_blank", withArrow: true }, import_react.default.createElement(DocumentIcon, null), " Learn how to set that up")) }));
};
...
var ArgsTable = (props) => {
  ...
  if ("error" in props) {
    let { error } = props;
    return import_react.default.createElement(EmptyBlock, null, error, " ", import_react.default.createElement(Ri, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, import_react.default.createElement(DocumentIcon, null), " Read the docs"));
  }
  if (isLoading)
...
function extractEventHiddenProperties(event) {
  ...
  if (event instanceof CustomEvent)
    for (let value2 of customEventSpecificProperties.filter((value22) => event[value22] !== void 0))
  ...
  return function(key, value2) {
    ...
    try {
      ...
      if (value2 instanceof Error && options.allowError)
        return { __isConvertedError__: true, errorProperties: { ...value2.cause ? { cause: value2.cause } : {}, ...value2, name: value2.name, message: value2.message, stack: value2.stack, "_constructor-name_": value2.constructor.name } };
...
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react.default.createElement(Qa, null, children);
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(ni, null, children);
...
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(oi, null, children);
  let tagID = slugs.slug(children.toLowerCase());
...
//# sourceMappingURL=chunk-ETK3SEBG.js.map
