...
(() => {
  ...
  // ../../node_modules/.pnpm/storybook@9.0.0_@testing-library+dom@9.3.4_prettier@2.8.8/node_modules/storybook/dist/controls/index.js
  ...
  // ../../node_modules/.pnpm/@storybook+addon-onboarding@9.0.0_storybook@9.0.0_@testing-library+dom@9.3.4_prettier@2.8.8_/node_modules/@storybook/addon-onboarding/dist/Onboarding-C2PY5T7U.js
  ...
  function F({ class: e2, ...t2 }) {
    ...
    return useEffect(() => {
      if (typeof window < "u" && r2.current) {
        if (a2.current)
          return a2.current.update(t2), a2.current.destroy;
  ...
  function getElementPosition(element, offset2, skipFix) {
    ...
    if (hasScrollParent && isFixedTarget) {
      ...
      parent instanceof HTMLElement && (parentTop = parent.scrollTop, !hasScrollParent && !hasPosition(element) && (top += parentTop), parent.isSameNode(scrollDocument()) || (top += scrollDocument().scrollTop));
  ...
  function replaceLocaleContent(input, step, steps) {
    ...
    if (getObjectType4(children) === "string" && children.includes("{step}"))
      return cloneElement(input, { children: replacer(children) });
    if (Array.isArray(children))
      return cloneElement(input, { children: children.map((child) => typeof child == "string" ? replacer(child) : replaceLocaleContent(child, step, steps)) });
  ...
  function Onboarding({ api }) {
    ...
    }), [api]), useEffect(() => api.emit(STORYBOOK_ADDON_ONBOARDING_CHANNEL, { step, type: "telemetry" }), [api, step]), !enabled)
      return null;
          ...
          function createUnionTypeChecker(arrayOfTypeCheckers) {
            ...
            for (var i2 = 0; i2 < arrayOfTypeCheckers.length; i2++) {
              ...
              if (typeof checker != "function")
                return printWarning("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + getPostfixForTypeWarning(checker) + " at index " + i2 + "."), emptyFunctionThatReturnsNull;
            }
            function validate(props, propName, componentName, location, propFullName) {
        ...
        constructor() {
          super(...arguments), __publicField(this, "isActive", !1), __publicField(this, "resizeTimeout"), __publicField(this, "scrollTimeout"), __publicField(this, "scrollParent"), __publicField(this, "state", { isScrolling: !1, mouseOverSpotlight: !1, showSpotlight: !0 }), __publicField(this, "hideSpotlight", () => {
            ...
            if (this.scrollParent !== document) {
              ...
              hasPosition(element, "sticky") && this.updateState({});
      ...
      Container_default = JoyrideTooltipContainer, JoyrideTooltip = class extends Component {
        ...
        render() {
          ...
          if (tooltipComponent) {
            ...
            component = createElement(Container_default, { ...this.getElementsProps(), continuous, index, isLastStep, size, step });
          return component;
        }
        ...
        componentDidUpdate(previousProps, previousState) {
          ...
          if (changed("status", [STATUS2.FINISHED, STATUS2.SKIPPED])) {
            ...
            changedFrom("status", [STATUS2.IDLE, STATUS2.READY], STATUS2.RUNNING) ? this.callback({ ...callbackData, type: EVENTS.TOUR_START }) : (changed("status") || changed("action", ACTIONS.RESET)) && this.callback({ ...callbackData, type: EVENTS.TOUR_STATUS });
...
`, Tooltip = ({ index, size, step, closeProps, primaryProps, tooltipProps }) => (useEffect(() => {
  ...
  // node_modules/.cache/storybook/f81023c37307cbb9b497a79625b928b134bc40ce02900fdcead02099bf960764/sb-manager/onboarding-1/manager-bundle.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();

  // ../../node_modules/.pnpm/@storybook+addon-onboarding@9.0.0_storybook@9.0.0_@testing-library+dom@9.3.4_prettier@2.8.8_/node_modules/@storybook/addon-onboarding/dist/manager.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  init_react();
